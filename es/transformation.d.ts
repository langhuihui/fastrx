...
export declare const switchMapTo: <T, U, R = U>(innerSource: Observable<U>, combineResults?: ResultSelector<T, U, R> | undefined) => import("./common").Operator<T, R>;
...
export declare const concatMapTo: <T, U, R = U>(innerSource: Observable<U>, combineResults?: ResultSelector<T, U, R> | undefined) => import("./common").Operator<T, R>;
...
export declare const mergeMapTo: <T, U, R = U>(innerSource: Observable<U>, combineResults?: ResultSelector<T, U, R> | undefined) => import("./common").Operator<T, R>;
...
export declare const exhaustMapTo: <T, U, R = U>(innerSource: Observable<U>, combineResults?: ResultSelector<T, U, R> | undefined) => import("./common").Operator<T, R>;
